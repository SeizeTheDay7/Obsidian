...
- `.ms-0`, `.ms-1`, `.ms-2`, `.ms-3`, `.ms-4`, `.ms-5`: 왼쪽 여백 (start)
- `.me-0`, `.me-1`, `.me-2`, `.me-3`, `.me-4`, `.me-5`: 오른쪽 여백 (end)
- `.mx-0`, `.mx-1`, `.mx-2`, `.mx-3`, `.mx-4`, `.mx-5`: 좌우 여백 (start and end)
- `.my-0`, `.my-1`, `.my-2`, `.my-3`, `.my-4`, `.my-5`: 상하 여백 (top and bottom)
...
- `.ps-0`, `.ps-1`, `.ps-2`, `.ps-3`, `.ps-4`, `.ps-5`: 왼쪽 패딩 (start)
- `.pe-0`, `.pe-1`, `.pe-2`, `.pe-3`, `.pe-4`, `.pe-5`: 오른쪽 패딩 (end)
- `.px-0`, `.px-1`, `.px-2`, `.px-3`, `.px-4`, `.px-5`: 좌우 패딩 (start and end)
- `.py-0`, `.py-1`, `.py-2`, `.py-3`, `.py-4`, `.py-5`: 상하 패딩 (top and bottom)
